...
export default function WorkTimelineError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("Work timeline route error:", error);
  }, [error]);

  return (
    <div className="mx-auto max-w-lg py-16 text-center">
      <h2 className="text-lg font-bold text-slate-800">업무 타임라인을 불러오지 못했습니다</h2>
