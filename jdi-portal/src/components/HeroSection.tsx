export default function HeroSection() {
  return (
    <div
      className="hidden lg:flex flex-col justify-center w-full max-w-xl xl:max-w-2xl animate-fade-in-up"
      style={{ animationDelay: "0.1s" }}
    >
      <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/60 border border-slate-200/60 backdrop-blur-sm text-slate-600 text-sm font-medium mb-8 w-fit shadow-sm">
      ...
      <h1 className="text-6xl xl:text-7xl font-bold tracking-tight text-slate-900 mb-8 leading-[1.15]">
        JDICOMPANY
        <br />
        <span className="text-5xl xl:text-6xl text-transparent bg-clip-text bg-gradient-to-r from-brand-600 to-indigo-600">
          Internal System
        </span>
      </h1>

      <p className="text-lg text-slate-600 max-w-lg leading-relaxed mb-2">
        상품 관리, 주문 처리, 고객 데이터까지
      </p>
      <p className="text-lg text-slate-500 max-w-lg leading-relaxed mb-14">
